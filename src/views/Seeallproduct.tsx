...
const Seeallproduct = () => {
    return (
        <div>
            ...
            <div className="flex flex-col lg:flex-row justify-evenly bg-gray-100  lg:-mt-[50px] space-x-0 space-y-10 bg...d:-mt[56px] md:pt-24 x1:flex-row xl:space-x-10 xl:space-y-0">
